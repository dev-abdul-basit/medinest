...
class AdHelper {
  static String get bannerAdUnitId {
    if (Debug.googleAd) {
      if (Platform.isAndroid) {
        return "ca-app-pub-3940256099942544/6300978111";///Enter your AdMobe Banner ad id for Android Here
  ...
  static String get interstitialAdUnitId {
    if (Debug.googleAd) {
      if (Platform.isAndroid) {
        return "ca-app-pub-3940256099942544/1033173712";///Enter your Interstitial Banner ad id for Android Here
      } else if (Platform.isIOS) {
