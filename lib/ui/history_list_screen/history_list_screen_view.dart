                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      padding: const EdgeInsets.only(top: 10,left: 14.0,right: 14.0),
                      ...
                      child: TabBar(
                        ...
                        indicatorWeight: 0,
                        indicatorPadding:  EdgeInsets.symmetric(horizontal: AppSizes.width_2_5,),
                        ...
                        tabs: [
                          Tab(
                              child: Container(
                                  ...
                                  margin: EdgeInsetsDirectional.symmetric(horizontal: AppSizes.width_2_5),
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(100), border: Border.all(width: 2, color: Get.theme.colorScheme.secondaryContainer)),
                                  child: CommonText(
                                      text: 'txtMedicine'.tr,
                                      textColor: logic.selectedTabIndex == 0 ? Get.theme.colorScheme.inverseSurface : Get.theme.colorScheme.secondaryContainer,
                          ...
                          Tab(
                              child: Container(
                                  ...
                                  child: CommonText(
                                      ...
                                      maxLines: 1,
                                      textColor: logic.selectedTabIndex == 1 ? Get.theme.colorScheme.inverseSurface : Get.theme.colorScheme.secondaryContainer,
                                      textAlign: TextAlign.center,
                                      fontSize: AppFontSize.size_12,
                                      fontWeight: FontWeight.w700))),
                        ],
                    ...
                    const Expanded(
                      child: TabBarView(
                        ...
                        children: [MedicineHistoryScreenPage(), AppointmentHistoryScreenPage()],
                      ),
                    ),
